...
#### INPUT PATH FOR LOCAL MACHINE ONLY 
...
#### INPUT PATH FOR NIFI SERVER ONLY 
...
# df_jr4
rows_with_nan = df_jr4[df_jr4.isna().all(axis=1)]
rows_with_nan
...
engine = create_engine('postgresql+psycopg2://##USER:##PASS@##IP HERE:5432/postgres')
